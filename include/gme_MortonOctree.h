...
namespace gme
{
    ...
    public:
                                ...
                                PointInt &upp) const
        {
            ...
            itemMid.index = mid;
            // ROFL_VAR5(first->index.transpose(), last->index.transpose(),
            // low.transpose(), mid.transpose(), upp.transpose());
            ...
            //            if (it != items_.end()) {
            //                ROFL_VARIABLE(it->index.transpose());
            //            } else {
            //                ROFL_VAR1("it == items_.end()");
            //            }
            return it;
        }
