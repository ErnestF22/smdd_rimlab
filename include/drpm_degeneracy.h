...
namespace drpm_degeneracy
{
    ...
    Eigen::Matrix<double, 6, 6> ComputeHessian(const drpm_degeneracy::VectorVector3<double> &points, const drpm_degeneracy::VectorVector3<double> &normals, const std::vector<double> &weights)
    {
        const size_t nPoints = points.size();
    ...
    VectorMatrix3<double> GetIsotropicCovariances(const size_t &N, const double stdev)
    {
        VectorMatrix3<double> covariances;
