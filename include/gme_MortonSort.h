...
namespace gme
{
    ...
    template <typename I>
    struct MortonIntegerTraits;

    template <>
    struct MortonIntegerTraits<int8_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<uint8_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<int16_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<uint16_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<int32_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<uint32_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<int64_t>
    {
    ...
    template <>
    struct MortonIntegerTraits<uint64_t>
    {
                     ...
                     Eigen::Matrix<I, Dim, 1> &low, Eigen::Matrix<I, Dim, 1> &mid, Eigen::Matrix<I, Dim, 1> &upp)
    {
        ...
        //        ROFL_VARIABLE2(dimSplit, levelSplit);
        for (int d = 1; d < Dim; ++d)
        {
            level = intervalPow2(v1(d), v2(d), low(d), mid(d), upp(d));
            //            ROFL_VARIABLE3(d, level, levelSplit);
            if (level > levelSplit)
            {
        ...
        //        ROFL_VAR1("split on dimension " << dimSplit << ", levelSplit " << levelSplit);
        //        for (int d = 0; d < Dim; ++d) {
        //            ROFL_VARIABLE6(d, v1(d), v2(d), low(d), mid(d), upp(d));
        //        }
    }
